...
export const HotkeyPermissionManager: React.FC<HotkeyPermissionManagerProps> = ({
  onPermissionGranted,
  ...
  const getStatusMessage = () => {
    ...
    if (permissionStatus.shortcut_registered) {
      return 'Global shortcut Cmd+Shift+C is active and ready!';
    }
    
    if (permissionStatus.accessibility_granted && permissionStatus.can_register_shortcut) {
    ...
    return 'Accessibility permissions required for global shortcut Cmd+Shift+C';
  };
  ...
  return (
    <div style={styles.container}>
      ...
      {permissionStatus?.accessibility_granted && !permissionStatus.shortcut_registered && (
        <div style={styles.instructions}>
          <p style={styles.instructionText}>
            ℹ️ Once the shortcut is registered, you can use <strong>Cmd+Shift+C</strong> to copy and clean selected text anywhere on your system.
          </p>
        </div>
      )}
    </div>
